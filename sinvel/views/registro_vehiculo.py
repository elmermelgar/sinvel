...
class RegistroVehiculo(object):
    ...
    @view_config(route_name='registrar_vehiculo', request_method='GET',
                 renderer='../templates/registrar_vehiculo.jinja2')
    ...
    @view_config(route_name='registro_control_entrada_reparacion',
                 renderer='../templates/registrar_entrada_reparacion.jinja2',
                 request_method='GET')
    ...
    @view_config(route_name='alerta_multa_cantidad_vehiculos',
                 renderer='../templates/alerta_multa_cantidad_vehiculos.jinja2',
                 request_method='GET')
